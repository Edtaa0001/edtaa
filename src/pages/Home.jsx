...
{/* <div className='flex justify-center gap-x-24 px-24 bg-gray-200 py-16'>

<div>
<p className='font-thin text-xl text-[#191970]'>GET IN TOUCH</p>
<p className='font-bold text-4xl pt-4'>We'd love to hear from you</p>

<p className='pt-4 max-w-[570px] text-xl'>Have a question ? Interested in partnering with us? Let's get the conversation started! Tell us a bit about how we can help below and we'll be in touch!</p>

<p className='text-lg font-semibold mt-6'>Full Name <span className='text-red-600 text-2xl pl-2'> *</span></p>
<input className='bg-white rounded-md px-3 py-3 w-[600px]' />

<div className='flex gap-x-2'>


  <div className='mt-6'>
<p className='text-lg font-semibold'>Email <span className='text-red-600 text-2xl pl-2'> *</span></p>
<input className='bg-white rounded-md px-3 py-3 w-[295px]' />
</div>

<div className='mt-6'>
<p className='text-lg font-semibold'>Phone Number <span className='text-red-600 text-2xl pl-2'> *</span></p>
<input className='bg-white rounded-md px-3 py-3 w-[295px]' />
</div>
</div>

<p className='text-lg font-semibold mt-6'>Message <span className='text-red-600 text-2xl pl-2'> *</span></p>
<textarea className='bg-white rounded-md px-3 py-3 w-[600px] h-[150px]' />

<div className='mt-4'><button className='px-6 py-3 rounded-md text-white bg-[#191970]'>Send Message</button></div>


</div>


<div><img src={getintouch} className='w-[600px] h-[700px] rounded-xl' /></div>
...
<div className='flex flex-col lg:flex-row justify-center lg:gap-x-24 px-4 md:px-8 lg:px-24 bg-gray-200 py-8 lg:py-16'>
  <div className='w-full lg:w-auto'>
    ...
    <p className='pt-4 max-w-[570px] text-base md:text-lg lg:text-xl'>
      Have a question? Interested in partnering with us? Let's get the conversation started! 
      Tell us a bit about how we can help below and we'll be in touch!
    </p>
    ...
    <div className='mt-6'>
      ...
      <input 
        className='bg-white rounded-md px-3 py-3 w-full lg:w-[600px] mt-2 outline-none' 
    ...
    <div className='flex flex-col md:flex-row gap-4 md:gap-x-2'>
      <div className='mt-6 w-full md:w-1/2'>
        ...
        <input 
          className='bg-white rounded-md px-3 py-3 w-full mt-2 outline-none' 
    ...
    <div className='mt-6'>
      ...
      <textarea 
        className='bg-white rounded-md px-3 py-3 w-full lg:w-[600px] h-[150px] mt-2 outline-none'
        // placeholder='Enter your message'
      />
    </div>

    <div className='mt-6 mb-8 lg:mb-0'>
      <button className='w-full md:w-auto px-6 py-3 rounded-md text-white bg-[#191970] hover:bg-[#131358] transition-colors'>
        Send Message
      </button>
    </div>
  </div>
